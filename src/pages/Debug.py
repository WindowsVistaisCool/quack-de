...
class DebugPage(NavigationPage):
    ...
    def _initUI(self):
        ...
        self.ui.add(ctk.CTkButton, "notify_test", text="Notify Test").grid(
            row=3, column=0, padx=20, pady=0, sticky="nw"
        )
        ...
        f_specs = self.ui.add(
            ...
            row=4, column=0, columnspan=2, padx=30, pady=10, sticky="we"
        )
    ...
    def _initCommands(self):
        ...
        def ashkjsahtsadf():
            self.appRoot.after(
                2000,
                lambda: NotifierService.notify(
                    "This is a test notification! har har har!"
                ),
            )
